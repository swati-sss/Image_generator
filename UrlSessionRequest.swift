...
//                compass?.currentStore = nil
    ...
    func removeCompassAndDestroyRoot() {
        ...
        compass = nil
        currentStore = nil
        clearMountedMapViewControllers()
    }

    private func clearMountedMapViewControllers() {
        mapViewController = nil

        mapRootViewController.children.forEach { child in
    ...
    func initialize(_ disableAutoZoom: Bool) {
        ...
        if compass != nil || mapViewController != nil || !mapRootViewController.children.isEmpty {
            removeCompassAndDestroyRoot()
        }
    ...
    func displayPinsV2(pins: [AisleTuple], isStaticPathVisible: Bool = false) {
        ...
        if isStaticPathVisible {
            ...
            var compassPins = aislePins.map { CompassPin.aisle($0) }
